...
class SliverPersistentDelegate extends SliverPersistentHeaderDelegate {
  ...
  final double maxHeaderHeight = 250;
  final double minHeaderHeight = kToolbarHeight + 50;
  final double maxImageSize = 145;
  ...
  Widget build(
    ...
    final percent = shrinkOffset / (maxHeaderHeight - 50);
    final percent2 = shrinkOffset / (maxHeaderHeight);
    final currentImageSize = (maxImageSize * (1 - percent)).clamp(
      minImageSize,
      maxImageSize,
    );
    final currentImagePosition = ((size.width / 2 - 75) * (1 - percent)).clamp(
      minImageSize,
      maxImageSize,
    );
    return Container(
